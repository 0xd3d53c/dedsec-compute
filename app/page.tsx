    ...
    <div className="min-h-screen bg-black text-green-400 matrix-bg">
      <div className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <header className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-green-400 text-black mb-4 sm:mb-6">
            <Shield className="w-8 h-8 sm:w-10 sm:h-10" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-3 sm:mb-4 dedsec-glow">DedSecCompute</h1>
          <p className="text-lg sm:text-xl text-green-300 mb-3 sm:mb-4">Distributed Computing Network</p>
          <p className="text-base sm:text-lg text-green-500 font-mono italic">"Power to the Collective"</p>
        </header>

        {/* Main Content */}
        <div className="max-w-6xl mx-auto">
          {/* Welcome Message */}
          <div className="dedsec-border rounded-lg p-4 sm:p-8 mb-6 sm:mb-8 bg-black/50">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-green-400">
              {">"} Welcome to the Collective
            </h2>
            <p className="text-sm sm:text-base text-green-300 mb-4 sm:mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="text-center p-4 border border-green-400/30 rounded-lg">
                <Users className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-green-400" />
                <h3 className="font-bold mb-2 text-sm sm:text-base">Join the Network</h3>
                <p className="text-xs sm:text-sm text-green-300">
                  Become a follower and contribute your computing power to the collective
                </p>
              </div>
              <div className="text-center p-4 border border-green-400/30 rounded-lg">
                <Zap className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-green-400" />
                <h3 className="font-bold mb-2 text-sm sm:text-base">Real Computing</h3>
                <p className="text-xs sm:text-sm text-green-300">
                  Perform actual mathematical operations, prime searches, and data processing
                </p>
              </div>
              <div className="text-center p-4 border border-green-400/30 rounded-lg">
                <Eye className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 text-green-400" />
                <h3 className="font-bold mb-2 text-sm sm:text-base">Full Transparency</h3>
                <p className="text-xs sm:text-sm text-green-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
            {/* Security & Privacy */}
            <div className="dedsec-border rounded-lg p-4 sm:p-6 bg-black/30">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Lock className="w-5 h-5 sm:w-6 sm:h-6 text-green-400" />
                <h3 className="text-lg sm:text-xl font-bold text-green-400">Security First</h3>
              </div>
              <ul className="space-y-1 sm:space-y-2 text-green-300 text-xs sm:text-sm">
            ...
            <div className="dedsec-border rounded-lg p-4 sm:p-6 bg-black/30">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Network className="w-5 h-5 sm:w-6 sm:h-6 text-green-400" />
                <h3 className="text-lg sm:text-xl font-bold text-green-400">Collective Power</h3>
              </div>
              <ul className="space-y-1 sm:space-y-2 text-green-300 text-xs sm:text-sm">
            ...
            <div className="dedsec-border rounded-lg p-4 sm:p-6 bg-black/30">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <Cpu className="w-5 h-5 sm:w-6 sm:h-6 text-green-400" />
                <h3 className="text-lg sm:text-xl font-bold text-green-400">Hardware Detection</h3>
              </div>
              <ul className="space-y-1 sm:space-y-2 text-green-300 text-xs sm:text-sm">
            ...
            <div className="dedsec-border rounded-lg p-4 sm:p-6 bg-black/30">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-green-400">Social Network</h3>
              </div>
              <ul className="space-y-1 sm:space-y-2 text-green-300 text-xs sm:text-sm">
          ...
          <div className="dedsec-border rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 bg-black/30">
            <div className="flex items-center gap-3 mb-4">
              <Terminal className="w-6 h-6 text-green-400" />
              <h3 className="text-xl font-bold text-green-400">Technical Capabilities</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-3 border border-green-400/20 rounded">
                <Code className="w-5 h-5 text-cyan-400" />
                <div>
                  <h4 className="font-bold text-cyan-400 text-sm">Real-time Processing</h4>
                  <p className="text-xs text-green-300">Live mathematical computations</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 border border-green-400/20 rounded">
                <Database className="w-5 h-5 text-yellow-400" />
                <div>
                  <h4 className="font-bold text-yellow-400 text-sm">Distributed Storage</h4>
                  <p className="text-xs text-green-300">Secure data distribution</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 border border-green-400/20 rounded">
                <Shield className="w-5 h-5 text-red-400" />
                <div>
                  <h4 className="font-bold text-red-400 text-sm">Cryptographic Security</h4>
                  <p className="text-xs text-green-300">End-to-end encryption</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Enhanced Footer */}
        <footer className="text-center mt-12 sm:mt-16 border-t border-green-400/30 pt-6 sm:pt-8">
          <div className="mb-4 sm:mb-6">
            <p className="text-green-400 font-bold text-lg sm:text-xl font-mono mb-2">
              "We are DedSec. We are Legion."
            </p>
            <p className="text-green-500 text-sm sm:text-base italic mb-2">
              "Information wants to be free. Computing power should be shared."
            </p>
            <p className="text-green-600 text-xs sm:text-sm font-mono">
              "The network is our weapon. The collective is our strength."
            </p>
          </div>

          <div className="text-green-600 text-xs sm:text-sm space-y-1 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-xs text-green-700 mb-4">
            <p>🔒 Zero-trust security model</p>
            <p>⚡ Real-time resource monitoring</p>
            <p>🌐 Global distributed network</p>
          </div>

          <div className="text-xs text-green-700 border-t border-green-400/20 pt-4">
